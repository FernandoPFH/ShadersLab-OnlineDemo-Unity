...
public class LiquidWobble : MonoBehaviour
{
    ...
    void Start()
    {
        objectRenderer = transform.parent.GetComponent<Renderer>();

        previousPosition = transform.parent.position;
        previousRotation = transform.parent.rotation.eulerAngles;
    }
    ...
    void Update()
    {
        ...
        // Calculate movement
        Vector3 velocity = (transform.parent.position - previousPosition) / deltaTime;
        Vector3 rotationDelta = transform.parent.rotation.eulerAngles - previousRotation;
